...
int main(int argc, const char *argv[])
{
    ...
    desc.add_options()
        ...
        ("state-file", po::value<std::string>(), "path to game state file")
        ("save-state-period", po::value<int>(), "save interval in ms")
    ...
    try
    {
        ...
        http_handler::RequestHandler handler{game, static_root, api_strand, randomize_spawn, state_file_path, save_period};
